...
from textSummarizer.entity import DataIngestionConfig, DataValidationConfig,DataValidationConfig,DataTransformationConfig,ModelTrainerConfig,ModelEvaluationConfig
